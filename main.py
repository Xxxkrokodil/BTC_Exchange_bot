...
def cancel_handler(update, context):
    keyboard = [[InlineKeyboardButton('Купить Биткоин', callback_data='option_1')],
                ...
                [InlineKeyboardButton('Поддержка / Оператор', url="https://t.me/MONOPOLYBANKER")],
...
def button(update, context):
    ...
    if data == "option_1":
        ...
        text = "Покупаем от 10000 руб. Если хотите продать BTC, пишите @MonopolyBanker"
...
updater = Updater("5937669643:AAHti4itlq11zypv20xkpRF6yk2qaUBTqlg", use_context=True)
bot = Bot("5937669643:AAHti4itlq11zypv20xkpRF6yk2qaUBTqlg")
